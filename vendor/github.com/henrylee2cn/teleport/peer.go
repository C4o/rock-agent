...
type (
	...
	BasePeer interface {
		...
		// SetTLSConfigFromFile sets the TLS config from []byte.
		SetTLSConfigFromBytes(tlsCert, tlsKey []byte, insecureSkipVerifyForClient ...bool) error
...
func (p *peer) SetTLSConfigFromBytes(tlsCert, tlsKey []byte, insecureSkipVerifyForClient ...bool) error {
	var err error
	p.tlsConfig, err = NewTLSConfigFromBytes(tlsCert , tlsKey , insecureSkipVerifyForClient...)
	return err
}
